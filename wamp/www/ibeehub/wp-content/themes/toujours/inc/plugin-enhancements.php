	...
	function __construct() {
		...
		$this->plugins = array(
			array(
				...
				'message' => sprintf(
					esc_html__( 'The %1$s is required to use some of this theme&rsquo;s features, including: ', 'toujours' ),
	...
	function get_theme_dependencies() {
		...
		if ( current_theme_supports( 'featured-content' ) ) :
			$dependencies['featured-content'] = array(
				'name' => __( 'Featured Content', 'toujours' ),
