...
$modulus_advanced_admin_details = __( ' you can customize any part of your site quickly and easily using customize options!', 'modulus' );
				...
				'sections' => array(
					...
					'header' => array(
						...
						'fields' => array(
                            ...
                            'header_image' => array(  
								'type' => 'image',
								'label' => __('Upload Header Background Image', 'modulus'),							),
							...
							'header_bg_height' => array(
								'type' => 'text',
								'label' => __('Header Background Image Minimum Height', 'modulus'),
                            ...
                            'header_bg_color' => array(
                                'type' => 'color',
                                'label' => __('Select Header Background Color', 'modulus'),   
