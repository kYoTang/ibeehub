...
*/
get_header(); ?>
	<!-- TODO: May be this can be done using hook/filter or not needed at all -->
	<style type="text/css">
		.item {
			overflow: hidden;
			margin: 10px;
		...
		<div id="primary" class="content-area sixteen columns">
			...
			<main id="main" class="site-main" role="main">
				...
				<div id="filters">
					...
					<!-- TODO: May be this micro clearance go with div#filters ? -->
				</div>
					...
					<?php
						...
						while ( have_posts() ) :
							...
							<li class="item <?php echo $skills; ?>">
								...
								<div class="portfolio1col portfolioeffects">
								<?php
									...
									<div class="content-details">
										...
										<div class="overlay_icon portfolio_link_icons">
											...
											<?php else :
												...
												<a class="icon-zoom" href="<?php echo $url; ?>"
												   rel="prettyPhoto[elasti]"><i class="fa fa-search"></i></a>
											<?php endif; ?>
								...
								<div class="excerpt1">
									<h4>
										<a href="<?php the_permalink(); ?>"
										   title="<?php _e( the_title_attribute(), 'webulous-framework' ); ?>">
											<?php the_title(); ?>
										</a>
									</h4>
									<a href="<?php the_permalink(); ?>" class="btn-readmore"><?php _e( 'Read More','webulous-framework' ); ?></a>
								</div>
