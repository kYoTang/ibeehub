 ...
 * @license GPL 2.0
 */
// TODO: Needs revamping of entire widget
class Wbls_Icon_Widget extends WP_Widget {

	public function __construct() {
		// widget actual processes
		parent::__construct(
			'icon-widget', // Base ID
			__('Icon', 'webulous-framework'), // Name
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('icon_placement') ?>"><?php _e('Icon Placement', 'webulous-framework') ?></label>
			<select id="<?php echo $this->get_field_id('icon_placement') ?>" name="<?php echo $this->get_field_name('icon_placement') ?>">
				<option value="top" <?php selected('top', $instance['icon_placement']) ?>><?php esc_html_e('Top', 'webulous-framework') ?></option>
				<option value="left" <?php selected('left', $instance['icon_placement']) ?>><?php esc_html_e('Left', 'webulous-framework') ?></option>
				<option value="right" <?php selected('right', $instance['icon_placement']) ?>><?php esc_html_e('Right', 'webulous-framework') ?></option>
