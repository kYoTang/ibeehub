<?php
	...
	*/
	 ...
	 *
	 */
	class Wbls_Fw_Sidebar_Generator {
		...
		public static function getInstance( ) {
			if( self::$instance === null) {
				self::$instance = new Wbls_Fw_Sidebar_Generator();
			}
			return self::$instance;
		}

		/**
		 * Wbls_Fw_Sidebar_Generator constructor.
		 */
		...
		public function enqueue_scripts(){
		    wp_enqueue_script('sidebar_generator', WBLS_FW_URI . 'admin/js/sidebar-generator.js', array('jquery'), '1.0.0', true );
		}
	...
	function generated_dynamic_sidebar($name='0'){
		Wbls_Fw_Sidebar_Generator::get_sidebar($name);	
		return true;
	}
